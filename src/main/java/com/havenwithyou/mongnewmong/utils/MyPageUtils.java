...
public class MyPageUtils {
  ...
  public Map<String, Object> pagingMap(String requestURI, String sort, String sortBy){
    pageLinkList = new ArrayList<>();
    for (int i = 0; i < totalPage; i++) {
      pageLinkList.add(i,requestURI+ "?page=" + (i+1) + "&sort=" + sort +"&sortBy="+sortBy + "&display=" + display);
    }
    Map<String, Object> pageMap = Map.of("pageLinkList",pageLinkList,
            "totalPage", totalPage,
                "beginPage", beginPage,
            "endPage", endPage,
            "display", display
