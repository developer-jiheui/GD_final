...
<div class="content-wrapper">
    ...
    <script src="${contextPath}/frontend/assets/js/app-user-view.js"></script>
    <script src="${contextPath}/frontend/assets/js/app-user-view-account.js"></script>
