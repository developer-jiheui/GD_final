...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 m-0 p-3">
                                            ...
                                            <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="text" class="form-control invoice-item-price mb-2" placeholder="00" min="12" />
                                                <div>
                                                    <span>Discount:</span>
    ...
    <!-- Page JS -->
    <script src="${contextPath}/frontend/assets/js/offcanvas-send-invoice.js"></script>
    <script src="${contextPath}/frontend/assets/js/app-invoice-add.js"></script>
