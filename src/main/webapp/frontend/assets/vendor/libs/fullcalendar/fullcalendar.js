    ...
    return function() {
        ...
        function x() {
            ...
            for (a.sort((function(e, t) {
                ...
                e.__d && (t = a.length, r = void 0, i = void 0, o = (s = (n = e).__v).__e, (l = n.__P) && (r = [], (i = g({}, s)).__v = s.__v + 1, N(l, s, i, n.__n, void 0 !== l.ownerSVGElement, null != s.__h ? [o] : null, r, null == o ? w(s) : o, s.__h), P(r, s), s.__e != o && C(s)), a.length > t && a.sort((function(e, t) {
                    return e.__v.__b - t.__v.__b
                })));
            x.__r = 0
        }
        function T(e, t, n, r, i, s, o, a, l, c) {
            ...
            for (n.__k = [], d = 0; d < t.length; d++)
                if (null != (p = n.__k[d] = null == (p = t[d]) || "boolean" == typeof p ? null : "string" == typeof p || "number" == typeof p || "bigint" == typeof p ? v(null, p, null, null, p) : Array.isArray(p) ? v(y, {
                    ...
                    if (p.__ = n, p.__b = n.__b + 1, null === (g = A[d]) || g && p.key == g.key && p.type === g.type)
                        A[d] = void 0;
                    else
                        for (f = 0; f < S; f++) {
                    ...
                    N(e, p, g = g || u, i, s, o, a, l, c),
                        m = p.__e,
                    (f = p.ref) && g.ref != f && (E || (E = []), g.ref && E.push(g.ref, null, p), E.push(f, p.__c || m, p)),
                        null != m ? (null == b && (b = m), "function" == typeof p.type && p.__k === g.__k ? p.__d = l = k(p, l, e) : l = O(e, p, g, A, m, l), "function" == typeof n.type && (n.__d = l)) : l && g.__e == l && l.parentNode != e && (l = w(g))
                }
            for (n.__e = b, d = S; d--;)
                null != A[d] && ("function" == typeof n.type && null != A[d].__e && A[d].__e == n.__d && (n.__d = I(r).nextSibling), j(A[d], A[d]));
            if (E)
        ...
        function k(e, t, n) {
            for (var r, i = e.__k, s = 0; i && s < i.length; s++)
                (r = i[s]) && (r.__ = e, t = "function" == typeof r.type ? k(r, t, n) : O(n, r, r, i, r.__e, t));
            return t
        }
        function M(e, t) {
            ...
            try {
                e:
                    if ("function" == typeof x) {
                        ...
                        null == o && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = H(n.__e, t, n, i, s, o, a, c);
                (d = r.diffed) && d(t)
            } catch (e) {
                t.__v = null,
        ...
        r.vnode = function(e) {
            ...
            if ("string" == typeof t) {
                ...
                "select" == t && null != r.defaultValue && (r.value = M(n.children).forEach((function(e) {
                    ...
                    e.props = r,
                n.class != n.className && (De.enumerable = "className" in n, null != n.className && (r.class = n.className), Object.defineProperty(r, "className", De))
            }
            e.$$typeof = pe,
            we && we(e)
        };
        ...
        class Ut {
            constructor(e)
            {
                let t = {},
                    ...
                    r = 0;
                for (let i in e)
                    i in It ? (n[i] = e[i], r = Math.max(It[i], r)) : (t[i] = e[i], i in Nt && (r = Math.max(Nt[i], r)));
            ...
            formatRange(e, t, n, r)
            {
                let {standardDateProps: i, extendedSettings: s} = this,
                    o = (a = e.marker, l = t.marker, (c = n.calendarSystem).getMarkerYear(a) !== c.getMarkerYear(l) ? 5 : c.getMarkerMonth(a) !== c.getMarkerMonth(l) ? 4 : c.getMarkerDay(a) !== c.getMarkerDay(l) ? 2 : _t(a) !== _t(l) ? 1 : 0);
                var a,
                    l,
                    c;
                if (!o)
        ...
        function gn(e, t, n={}) {
            if (e === t)
                return !0;
            for (let o in t)
                if (!(o in e && (r = e[o], i = t[o], s = n[o], r === i || !0 === s || s && s(r, i))))
                    return !1;
            var r,
                i,
                s;
        ...
        class Nn extends D {
            constructor()
            {
                super(...arguments),
                    ...
                    this.handleEl = e => {
                        this.el = e,
                        this.props.elRef && (xn(this.props.elRef, e), e && this.didMountMisfire && this.componentDidMount())
                    }
            }
            render()
            {
        ...
        class Ti {
            ...
            insertEntryAt(e, t)
            {
                ...
                -1 === t.lateral ? (Ii(r, t.level, t.levelCoord), Ii(n, t.level, [e])) : Ii(n[t.level], t.lateral, e),
        ...
        function Ji(e, t, n={}, r) {
            return !(e.eventDrag && !function(e, t, n, r) {
                ...
                for (let r in l) {
                    ...
                    for (let e of p.allows) {
                        let i,
                            ...
                            a = b.defs[m.defId],
                            l = b.instances[r];
                        if (i = a ? new Or(t, a, l) : new Or(t, m), !e(Rr(s, t), i))
                            return !1
                    }
                }
                return !0
                ...
                if (r && (c = r(c)), !Ki(c.constraints, l, i, e.businessHours, t))
                    return !1;
        ...
        class mo {
            ...
            processRawCalendarOptions(e, t)
            {
                let {locales: n, locale: r} = tn([qt, e, t]),
                    ...
                    g = !1;
                for (let e in d)
                    -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || $t[e] && e in h && $t[e](h[e], d[e])) ? u[e] = f[e] : l[e] ? (u[e] = l[e](d[e]), g = !0) : c[e] = h[e];
            ...
            processRawViewOptions(e, t, n, r, i)
            {
                let s = tn([qt, e.optionDefaults, n, r, e.optionOverrides, i]),
                    ...
                    u = {};
                for (let e in s)
                    s[e] === l[e] || $t[e] && $t[e](s[e], l[e]) ? a[e] = c[e] : (s[e] === this.currentCalendarOptionsInput[e] || $t[e] && $t[e](s[e], this.currentCalendarOptionsInput[e]) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? a[e] = o[e](s[e]) : u[e] = s[e], d = !0);
                        ...
                        if (this.isRendering) {
                            ...
                            En((() => {
                                U(m(ni, {
                                    ...
                                    theme: e.theme,
                                    emitter: e.emitter
                                }, ((t, n, r, i) => (this.setClassNames(t), this.setHeight(n), m(In.Provider, {
                            ...
                            this.isRendered && (this.isRendered = !1, U(null, this.el), this.setClassNames([]), this.setHeight(""))
                    },
                    function(e) {
                ...
                if (c)
                    for (let e of t) {
                        let {seg: t} = e,
                            ...
                            v = "",
                            y = "";
                        p && (a.isRtl ? (y = 0, v = c.lefts[t.lastCol] - c.lefts[t.firstCol]) : (v = 0, y = c.rights[t.firstCol] - c.rights[t.lastCol])),
                            h.push(m("div", {
        ...
        class ya {
            ...
            handleMove(e, t)
            {
                if (this.isEnabled) {
                    ...
                    this.isAnimating || (this.isAnimating = !0, this.requestAnimation(va()))
                }
            }
            stop()
            {
        ...
        class Sa {
            ...
            handleMove(e, t)
            {
                ...
                !t && Da(this.movingHit, n) || (this.movingHit = n, this.emitter.trigger("hitupdate", n, !1, e))
            }
            prepareHits()
            {
                this.offsetTrackers = ln(this.droppableStore, (e => (e.component.prepareHits(), new Ea(e.el))))
            }
            releaseHits()
            {
                ...
                for (let s in n) {
                    ...
                    if (a && a.isWithinClipping(e, t)) {
                        ...
                        if (l >= 0 && l < u && c >= 0 && c < h) {
                            ...
                            e && Wn(e.dateProfile.activeRange, e.dateSpan.range) && (!i || e.layer > i.layer) && (e.componentId = s, e.context = o.context, e.rect.left += n, e.rect.right += n, e.rect.top += r, e.rect.bottom += r, i = e)
                        }
                    }
                }
                return i
                ...
                super(e),
                    ...
                    this.handleHitUpdate = (e, t) => {
                        ...
                        if (e) {
                            ...
                            i === s || t.editable && t.droppable ? (o = function(e, t, n) {
                                let r = e.dateSpan,
                                    ...
                                    o = i.range.start,
                                    a = {};
                                r.allDay !== i.allDay && (a.allDay = i.allDay, a.hasEnd = t.context.options.allDayMaintainDuration, i.allDay && (s = bt(s)));
                                ...
                                for (let r of n)
                                    r(c, e, t);
                                return c
                            }(r, e, s.getCurrentData().pluginHooks.eventDragMutationMassagers), o && (a = xr(n, s.getCurrentData().eventUiBases, o, s), c.mutatedEvents = a, Xi(c, e.dateProfile, s) || (l = !0, o = null, a = null, c.mutatedEvents = {
                                defs: {},
                                instances: {}
                            }))) : s = null
                        }
                        this.displayDrag(s, c),
                            l ? Ze() : Xe(),
                        t || (i === s && Da(r, e) && (o = null), this.dragging.setMirrorNeedsRevert(!o), this.dragging.setMirrorIsVisible(!e || !this.subjectEl.getRootNode().querySelector(".fc-event-mirror")), this.receivingContext = s, this.validMutation = o, this.mutatedRelevantEvents = a)
                    },
                    ...
                    constructor(e)
                    {
                        super(e),
                            ...
                            this.handleHitUpdate = (e, t, n) => {
                                ...
                                a && (l = xr(i, r.getCurrentData().eventUiBases, a, r), d.mutatedEvents = l, Xi(d, e.dateProfile, r) || (c = !0, a = null, l = null, d.mutatedEvents = null)),
                                    l ? r.dispatch({
                                    ...
                                    c ? Ze() : Xe(),
                                t || (a && Da(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                            },
                            this.handleDragEnd = e => {
                                let {context: t} = this.component,
        ...
        class qa extends _n {
            ...
            updateSizing()
            {
                ...
                var n;
                t.onCoords && null !== t.clientWidth && this.rootElRef.current.offsetHeight && t.onCoords(new Qa(new Di(this.rootElRef.current, (n = this.slatElRefs.currentMap, t.slatMetas.map((e => n[e.key]))), !1, !0), this.props.dateProfile, e.options.slotDuration))
            }
        }
        function Za(e, t) {
            let n,
                        ...
                        let {segRects: o, hiddenGroups: a} = function(e, t, n) {
                                ...
                                return s = function(e, t) {
                                    const n = nl(((e, t, n) => Mi(e)), ((e, t, r) => {
                                        let i,
                                            {nextLevelNodes: s, thickness: o} = e,
                                            a = o + r,
                                            l = o / a,
                                            c = [];
                                        if (s.length)
            ...
            let s = new Date(0),
                ...
                l = n || function(e) {
                    ...
                    for (t = pl.length - 1; t >= 0; t -= 1)
                        if (n = st(pl[t]), r = dt(n, e), null !== r && r > 1)
                            return n;
                    return e
                }(r),
                c = [];
