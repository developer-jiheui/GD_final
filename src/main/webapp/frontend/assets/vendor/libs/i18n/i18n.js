                        ...
                        !function(e) {
                            ...
                            function b() {
                                return this.bodyUsed = !1, this._initBody = function(t) {
                                    ...
                                    if (n)
                                        return n;
                                    if (this._bodyBlob)
                                        return t = this._bodyBlob, o = g(e = new FileReader), e.readAsText(t), o;
                                    if (this._bodyArrayBuffer)
                            ...
                            function w(t, e) {
                                ...
                                if (t instanceof w) {
                                    ...
                                    this.url = String(t);
                                if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new f(e.headers)), this.method = (n = (o = e.method || this.method || "GET").toUpperCase(), v.indexOf(n) > -1 ? n : o), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && r)
                            ...
                            k.polyfill = !0,
                            o.fetch || (o.fetch = k, o.Headers = f, o.Request = w, o.Response = S),
                            e.Headers = f,
                            e.Request = w,
                            e.Response = S,
                            e.fetch = k
        ...
        return function() {
            ...
            class b extends n {
                ...
                addResourceBundle(t, e, o, n, r)
                {
                    let i = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {
                        ...
                        s = [t, e];
                    t.indexOf(".") > -1 && (s = t.split("."), n = o, o = e, e = s[1]),
                    this.addNamespaces(e);
                    let a = c(this.data, s) || {};
                    n ? p(a, o, r) : a = {
                        ...a,
                            ...
                            this.isValidLookup(e) || (i = t, !w[`${f[0]}-${t}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(i) && (w[`${f[0]}-${t}`] = !0, this.logger.warn(`key "${o}" for languages "${f.join(", ")}" won't get resolved as namespace "${i}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), f.forEach((o => {
                                ...
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                                    ...
                                    if (c && (i.push(l + t), s.ordinal && 0 === t.indexOf(n) && i.push(l + t.replace(n, this.options.pluralSeparator)), p && i.push(l + e)), h) {
                                        ...
                                        i.push(o),
                                        c && (i.push(o + t), s.ordinal && 0 === t.indexOf(n) && i.push(o + t.replace(n, this.options.pluralSeparator)), p && i.push(o + e))
                                    }
                                }
                                let a;
                                for (; a = i.pop();)
                                    this.isValidLookup(e) || (n = a, e = this.getResource(o, t, a, s))
                            })))
                        }))
                    })), {
                        res: e,
            ...
            class O {
                ...
                getFallbackCodes(t, e)
                {
                    if (!t)
                        return [];
                    if ("function" == typeof t && (t = t(e)), "string" == typeof t && (t = [t]), "[object Array]" === Object.prototype.toString.apply(t))
                        return t;
                    if (!e)
                        return t.default || [];
                    let o = t[e];
            ...
            class E {
                constructor(t)
                {
                    ...
                    this.options.compatibilityJSON && !j.includes(this.options.compatibilityJSON) || "undefined" != typeof Intl && Intl.PluralRules || (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")),
                    this.rules = function() {
                        const t = {};
                        return k.forEach((e => {
                            e.lngs.forEach((o => {
            ...
            class N {
                ...
                interpolate(t, e, o, n)
                {
                    ...
                    return [{
                        ...
                        for (s = 0; r = e.regex.exec(t);) {
                            ...
                            if (t = t.replace(r[0], l), h ? (e.regex.lastIndex += i.length, e.regex.lastIndex -= r[0].length) : e.regex.lastIndex = 0, s++, s >= this.maxReplaces)
                                break
                        }
                    })), t
                }
                nest(t, e)
                {
                    ...
                    for (; o = this.nestingRegexp.exec(t);) {
                        ...
                        if (n = e(s.call(this, o[1].trim(), r), r), n && o[0] === t && "string" != typeof n)
                            return n;
                        "string" != typeof n && (n = a(n)),
                        n || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${t}`), n = ""),
            ...
            class F extends n {
                ...
                init()
                {
                    ...
                    if (this.options = {
                        ...
                        !e || this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format || (s.formatter = i(e), s.formatter.init(s, this.options), this.options.interpolation.format = s.formatter.format.bind(s.formatter)),
                        ...
                        this.modules.languageDetector && (s.languageDetector = i(this.modules.languageDetector), s.languageDetector.init && s.languageDetector.init(s, this.options.detection, this.options)),
                ...
                changeLanguage(t, e)
                {
                    ...
                    const r = t => {
                        ...
                        i = (t, i) => {
                            i ? (r(i), this.translator.changeLanguage(i), this.isLanguageChangingTo = void 0, this.emit("languageChanged", i), this.logger.log("languageChanged", i)) : this.isLanguageChangingTo = void 0,
                            n.resolve((function() {
                        ...
                        a = e => {
                            ...
                            o && (this.language || r(o), this.translator.language || this.translator.changeLanguage(o), this.services.languageDetector && this.services.languageDetector.cacheUserLanguage && this.services.languageDetector.cacheUserLanguage(o)),
            ...
            var pt = [],
                ...
                gt = {
                    ...
                    cacheUserLanguage: function(t, e) {
                        e.lookupCookie && "undefined" != typeof document && function(t, e, o, n) {
                            ...
                            o && (r.expires = new Date, r.expires.setTime(r.expires.getTime() + 60 * o * 1e3)),
                            n && (r.domain = n),
                ...
                kt = {
                    ...
                    lookup: function(t) {
                        var e,
                            o = t.htmlTag || ("undefined" != typeof document ? document.documentElement : null);
