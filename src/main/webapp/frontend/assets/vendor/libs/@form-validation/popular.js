                        ...
                        var e = {
                            ...
                            t = function() {
                                ...
                                return e.prototype.on = function(e, t) {
                                    ...
                                    if (i.message = this.filter.execute("validator-message", i.message, [this.locale, e, a]), !this.validators[a] || !1 === i.enabled)
                                    ...
                                    if (("radio" === o || "checkbox" === o ? [r[0]] : r).forEach((function(r) {
                                        ...
                                        "Invalid" === t && (this.emit("core.field.invalid", e), this.results.set(e, "Invalid"));
                                    else
                                        switch (t) {
                                        case "NotValidated":
                            ...
                            i = function() {
                                ...
                                }, e.prototype.onEnabled = function() {}, e.prototype.onDisabled = function() {}, e.prototype.install = function() {}, e.prototype.uninstall = function() {}, e
                            }(),
                            o = function(e, t) {
                                ...
                                return function(t, n) {
                                    ...
                                    for (var e, t = this, n = this.core.getFormElement(), i = new RegExp("^".concat(this.opts.pluginPrefix, "([a-z0-9-]+)(___)*([a-z0-9-]+)*$")), r = n.attributes.length, o = {}, a = 0; a < r; a++) {
                                        ...
                                        if (d && 4 === d.length) {
                                            ...
                                            o[c] = Object.assign({}, d[3] ? ((e = {})[this.toCamelCase(d[3])] = l, e) : {
                                                enabled: "" === l || "true" === l
                                            }, o[c])
                                        }
                                    }
                        ...
                        var e = a,
                            ...
                            i = function(e) {
                                function i(t) {
                                    ...
                                    }, n(t)), r.ignoreValidationFilter = r.ignoreValidation.bind(r), r
                                }
                                return function(e, n) {
                                    if ("function" != typeof n && null !== n)
                                        throw new TypeError("Class extends value " + String(n) + " is not a constructor or null");
                            ...
                            i = function(e) {
                                ...
                                return function(e, n) {
                                    ...
                                    if (this.messages.has(o)) {
                                        ...
                                        if (s || e.result.valid)
                                            s && !e.result.valid ? (s.innerHTML = this.getMessage(e.result), this.core.emit("plugins.message.displayed", {
                                                element: e.element,
                                                field: e.field,
                        ...
                        var e = a,
                            ...
                            o = function(e) {
                                ...
                                return function(e, t) {
                                    ...
                                    var e,
                                        n = this;
                                    i(this.core.getFormElement(), ((e = {})[this.opts.formClass] = !0, e["fv-plugins-framework"] = !0, e)),
                                    ...
                                    i(this.core.getFormElement(), ((e = {})[this.opts.formClass] = !1, e["fv-plugins-framework"] = !1, e)),
                                    this.core.off("core.element.ignored", this.elementIgnoredHandler).off("core.element.validating", this.elementValidatingHandler).off("core.element.validated", this.elementValidatedHandler).off("core.element.notvalidated", this.elementNotValidatedHandler).off("plugins.icon.placed", this.iconPlacedHandler).off("core.field.added", this.fieldAddedHandler).off("core.field.removed", this.fieldRemovedHandler),
                                    this.opts.defaultMessageContainer && (this.core.deregisterPlugin(o.MESSAGE_PLUGIN), this.core.off("plugins.message.placed", this.messagePlacedHandler))
                                }, o.prototype.onEnabled = function() {
                                    var e;
                                    i(this.core.getFormElement(), ((e = {})[this.opts.formClass] = !0, e)),
                                    this.opts.defaultMessageContainer && this.core.enablePlugin(o.MESSAGE_PLUGIN)
                                }, o.prototype.onDisabled = function() {
                                    var e;
                                    i(this.core.getFormElement(), ((e = {})[this.opts.formClass] = !1, e)),
                                    this.opts.defaultMessageContainer && this.core.disablePlugin(o.MESSAGE_PLUGIN)
                                }, o.prototype.onIconPlaced = function(e) {}, o.prototype.onMessagePlaced = function(e) {}, o.prototype.onFieldAdded = function(e) {
                                    var t = this,
                                        n = e.elements;
                                    n && (n.forEach((function(e) {
                                        var n,
                                    ...
                                    if (l)
                                        if (e.valid) {
                                            ...
                                            i(l, ((t = {})[this.opts.rowInvalidClass] = !0, t[this.opts.rowValidatingClass] = !1, t[this.opts.rowValidClass] = !1, t))
                        ...
                        var e = a,
                            ...
                            i = function(e) {
                                function i(t) {
                                    ...
                                    return i.invalidFields = new Map, i.opts = Object.assign({}, {
                                        enabled: !0
                                    }, n(t)), i.validatorHandler = i.onValidatorValidated.bind(i), i.shouldValidateFilter = i.shouldValidate.bind(i), i.fieldAddedHandler = i.onFieldAdded.bind(i), i.elementNotValidatedHandler = i.onElementNotValidated.bind(i), i.elementValidatingHandler = i.onElementValidating.bind(i), i
                                }
                                return function(e, n) {
                                    if ("function" != typeof n && null !== n)
                                        throw new TypeError("Class extends value " + String(n) + " is not a constructor or null");
                                ...
                                return function(t, n) {
                                    ...
                                    if (this.isButtonClicked = !0, t instanceof HTMLElement)
                                        if (this.opts.aspNetButton && !0 === this.isFormValid)
                                            ...
                                            n && i && (this.hiddenClickedEle.setAttribute("name", n), this.hiddenClickedEle.setAttribute("value", i)),
                                            this.validateForm(e)
                                        }
                        ...
                        var e = a,
                            ...
                            i = function(e) {
                                ...
                                return function(e, n) {
                                    ...
                                    })["fv-plugins-tooltip--".concat(this.opts.placement)] = !0, e)),
                            ...
                            return {
                                validate: function(t) {
                                    ...
                                    if (window.File && window.FileList && window.FileReader) {
                                        ...
                                        if (n = t.value.substr(t.value.lastIndexOf(".") + 1), r.length > 0 && -1 === r.indexOf(n.toLowerCase()))
                                            return {
                                                meta: {
                                                    error: "INVALID_EXTENSION",
                                                    ext: n
                                        ...
                                        if (i = e(t.value), t.options.validateFileName && !t.options.validateFileName(i))
                                            return {
                                                meta: {
                                                    error: "INVALID_NAME",
                                                    name: i
