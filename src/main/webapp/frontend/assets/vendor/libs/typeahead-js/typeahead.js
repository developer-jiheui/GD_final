                        ...
                        return s.Bloodhound = (e = t, n = function() {
                            ...
                            return u.setMaxPendingRequests = function(t) {
                                ...
                                _get: function(e, n) {
                                    ...
                                    this.cancelled || s !== this.lastReq || ((o = i[s]) ? o.done(a).fail(c) : t < r ? (t++, i[s] = this._send(e).done(a).fail(c).always((function() {
                                        t--,
                                        delete i[s],
                            ...
                            return n.mixin(i.prototype, {
                                    ...
                                    n.each(e, (function(e) {
                                        ...
                                        n.each(u, (function(e) {
                                            var n,
                                                r,
                                                u;
                                            for (n = i.trie, r = e.split(""); u = r.shift();)
                                ...
                                search: function(e) {
                                    ...
                                    return i = r(this.queryTokenizer(e)), n.each(i, (function(e) {
                                        ...
                                        if (s && 0 === s.length)
                                            return !1;
                                        for (n = o.trie, i = e.split(""); n && (r = i.shift());)
                                            n = n[t][r];
                                        if (!n || 0 !== i.length)
                                            return s = [], !1;
                                        u = n.i.slice(0),
                            ...
                            o = {
                                initialize: function(t, o) {
                                    ...
                                    return o = n.isArray(o) ? o : [].slice.call(arguments, 1), a = i((t = t || {}).classNames), this.each((function() {
                                        ...
                                        (m || y) && (d.css(a.css.wrapper), i.css(m ? a.css.input : a.css.inputWithNoHint), i.wrap(d).parent().prepend(m ? p : null).append(y ? g : null)),
                                        S = y ? h : c,
                                        v = new r({
                                            el: i
                                        }),
