...
$(function() {
    ...
    e.length && (a = e.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 1,
            render: function(a, e, t, s) {
                return '<a href="app-invoice-preview.html"><span class="fw-medium">#' + t.invoice_id + "</span></a>"
            }
        }, {
            targets: 2,
            render: function(a, e, t, s) {
                var n = t.invoice_status,
                    l = t.due_date;
                return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + n + '<br> <span class="fw-medium">Balance:</span> ' + t.balance + '<br> <span class="fw-medium">Due Date:</span> ' + l + "</span>'>" + {
            ...
            render: function(a, e, t, s) {
                ...
                return '<div class="d-flex justify-content-start align-items-center"><div class="avatar-wrapper"><div class="avatar avatar-sm me-2">' + (!0 === r ? '<img src="' + assetsPath + "img/avatars/" + (i + ".png") + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (r = (((r = (n = t.client_name).match(/\b\w/g) || []).shift() || "") + (r.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><a href="pages-profile-user.html" class="text-body text-truncate"><span class="fw-medium">' + n + '</span></a><small class="text-truncate text-muted">' + l + "</small></div></div>"
            }
        }, {
            targets: 4,
            render: function(a, e, t, s) {
            ...
            render: function(a, e, t, s) {
                t = t.balance;
                return 0 === t ? '<span class="badge bg-label-success"> Paid </span>' : '<span class="d-none">' + t + "</span>" + t
            }
        }, {
            targets: 7,
            visible: !1
