...
document.addEventListener("DOMContentLoaded", function() {
    {
        ...
        function s() {
            ...
            for (e.classList.remove("fc-button-primary"), e.classList.add("d-lg-none", "d-inline-block", "ps-0"); e.firstChild;)
                e.firstChild.remove();
        ...
        y.addEventListener("click", e => {
            ...
            y.classList.contains("btn-add-event") ? r && (n = {
            ...
            }, x.value && (n.url = x.value), T.checked && (n.allDay = !0), n = n, l.push(n), i.refetchEvents(), C.hide()) : r && (n = {
                id: a.id,
                title: E.value,
                start: k.value,
                end: w.value,
                ...
                display: "block",
                allDay: !!T.checked
            }, (t = n).id = parseInt(t.id), l[l.findIndex(e => e.id === t.id)] = t, i.refetchEvents(), C.hide())
        }),
